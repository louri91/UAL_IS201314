...
<body bgcolor="#98BCDA">
	...
	<%
		...
		/*			request.getParameter("nombre"),
					Integer.parseInt(request.getParameter("numMinimo")),
					Integer.parseInt(request.getParameter("numMaximo")),
					request.getParameter("tipoMesa"),
					Boolean.parseBoolean(request.getParameter("clasificatoria")),
					request.getParameter("premio"),
					request.getParameter("jugadores")); */
	...
	<center>
		<h2>
			<font color="#cc0000">El nombre del torneo ya existe.
				Escriba otro.</font>
		</h2>
	</center>
	<%
